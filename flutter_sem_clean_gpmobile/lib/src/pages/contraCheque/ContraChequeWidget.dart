...
import 'package:gpmobile/src/pages/contraCheque/ContraChequeBloc.dart';
import 'package:gpmobile/src/pages/contraCheque/ContraChequeModel.dart';
...
class _ContraChequeWidgetState extends State<ContraChequeWidget> {
  ...
  String cmes = new DateTime(
          DateTime.now().year, DateTime.now().month - 1, DateTime.now().day)
      .month
      .toString()
      .padLeft(2, '0');

  String cano = new DateTime(
          DateTime.now().year, DateTime.now().month - 1, DateTime.now().day)
      .year
      .toString();
  //initState
            ...
            if (map == ConfirmAction.OK) {
              setState(() {
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                    ...
                    builder: (context) => PontoWidget(cmes, cano)));
              });
            }
          });
        } else {
