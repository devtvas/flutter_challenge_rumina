...
//VARIAVEIS
  ...
  String campoMenor11 = 'Digite uma senha com mais de 11 caracteres!';
  ...
  void initState() {
    ...
    SharedPreferencesBloc().buscaParametro("cpfcolaborador").then((retorno) {
      _senha = retorno;
    });
  }
  ...
  Future<TextEditingController> _validarDados() async {
    int _notificar = 1; // notificar = 1
    int _trocarSenha = 3; //trocar senha = 3
    //erro validacao
