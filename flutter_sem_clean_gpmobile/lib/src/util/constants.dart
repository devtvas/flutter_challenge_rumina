...
const APP_NAME = 'gpmobile';
const APP_EMPRESA = '© 2021 H EGIDIO, Group';
final kAppIcon =
    Image.asset('res/images/launcher_icon.png', height: 64.0, width: 64.0);
const APP_DESCRIPTION = 'Um app para gestao de pessoas, with '
    // 'side-by-side  source code view.'
    '\n\nDeveloped by equiplex.';
...
final String RECUPERAR_SENHA = '/recuperar_senha';
final String SPLASH_SCREEN = '/splashscreen';
final String HOME = '/home';
final String HOLERITE = '/contra_cheque';
final String PONTO = '/ponto';
final String LISTAR_DOC = '/listar_doc';
final String MENSA_VIEW = '/mensa_view';
final String TROCAR_SENHA = '/trocar_senha';
